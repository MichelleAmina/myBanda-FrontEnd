...
function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        "https://mybanda-backend-88l2.onrender.com/signup",
        {
          method: "POST",
          headers: {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      const response = await fetch(
        "https://mybanda-backend-88l2.onrender.com/login",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
        ...
        <form onSubmit={handleSubmit}>
          ...
          {/* <label id="form-label" htmlFor="name">Name:</label>
                    <input 
                        ...
                        required 
                    /> */}
          <label id="form-label" htmlFor="username">
            Username:
          </label>
          <input
            type="text"
          ...
          <input
            ...
            required
          />
          <label id="form-label" htmlFor="role">
            Role:
          </label>
          <select
            name="role"
          ...
          <label id="form-label" htmlFor="password">
            Password:
          </label>
          <input
            type="password"
            ...
            required
          />
          <label id="form-label" htmlFor="confirmPassword">
            Confirm password:
          </label>
          <input
            type="password"
          ...
          {showLocationInput && (
            <>
              <label id="form-label" htmlFor="location">
                Location:
              </label>
              <input
                type="text"
          ...
          {showContactInput && (
            <>
              <label id="form-label" htmlFor="contact">
                Contact:
              </label>
            </>
          )}
